...
//등록일자: 2019.04.23 
//등록자   : 박현조
public class BranchInfoByNameRequest {
	...
	public BranchInfoByNameRequest(String serviceKey,Integer numOfRows, Integer pageNo,String branchName,String SG_APIM) {
	...
	public String toString() {
		return "ServiceKey="+serviceKey+",numberOfRows="+numOfRows+",pageNo="+pageNo+",branchName="+branchName;
	}
