...
//아이원잡 채용공고 통계 조회 서비스 
@RestController
@RequestMapping("/IonejobCareersStatisticsView")
public class IoneJobCareersStatisticsViewAPiController {

	@Autowired
	LogApiDataService logApiDataService;
	private Logger logger = LoggerFactory.getLogger(IoneJobCareersStatisticsViewAPiController.class);
	//전처리 
	//필터
	@Autowired
