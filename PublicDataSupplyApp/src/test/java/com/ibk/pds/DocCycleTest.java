...
@SpringBootTest
public class DocCycleTest {

	private Logger logger = LoggerFactory.getLogger(DocCycleTest.class);
	...
	@Test
	public void docCyclceTest() {
		DocCycle docCycle1 = new DocCycle("U001","수시로");
		DocCycle docCycle2 = new DocCycle("U002","주1회");
		DocCycle docCycle3 = new DocCycle("U003","월1회");
		DocCycle docCycle4 = new DocCycle("U004","분기1회");
		DocCycle docCycle5 = new DocCycle("U005","반기1회");
		DocCycle docCycle6 = new DocCycle("U006","년 1회");
		
		
		docCycleRepository.insert(docCycle1);
		docCycleRepository.insert(docCycle2);
		docCycleRepository.insert(docCycle3);
		docCycleRepository.insert(docCycle4);
		docCycleRepository.insert(docCycle5);
		docCycleRepository.insert(docCycle6);
